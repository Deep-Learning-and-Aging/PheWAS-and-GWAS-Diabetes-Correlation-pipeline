...
def main():
    ...
    eye = '/n/groups/patel/Alan/Aging/Medical_Images/data/GWAS_data_Age_Eyes.tab'
    ...
    eye_ids.to_csv('~/PheWAS-and-GWAS-Diabetes-Correlation-pipeline/in_pop_IDs/Eyes_in_sample_pop_IDs.txt', index=False, header=False)
